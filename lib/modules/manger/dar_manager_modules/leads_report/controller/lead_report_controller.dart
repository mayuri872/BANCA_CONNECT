...
import '../../reports/models/manager_data_model.dart';
import '../../reports/models/zone_model.dart';
...
class LeadReportController extends GetxController
  ...
  RxList<ResponseManagerModel> responceManagerList =
      RxList<ResponseManagerModel>();
  RxList<ResponseDailyActivityReport> responceZoneManagerfilters =
      RxList<ResponseDailyActivityReport>();
  RxList<ResponseDailyActivityReport> dSRFilter =
      RxList<ResponseDailyActivityReport>();
